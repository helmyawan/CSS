window.onload = function() {
	// facebook icon
    var fbImage = document.getElementById("social-wrapper-element-facebook");
	fbImage.onmouseover = function() {  fbImage.src = "./img/facebook_icon_hover.png"; }
	fbImage.onmouseout = function() {  fbImage.src = "./img/facebook_icon.png"; }

	// twitter icon
	var twImage = document.getElementById("social-wrapper-element-twitter");
	twImage.onmouseover = function() {  twImage.src = "./img/twitter_icon_hover.png"; }
	twImage.onmouseout = function() {  twImage.src = "./img/twitter_icon.png"; }

	// youtube icon
	var ytImage = document.getElementById("social-wrapper-element-youtube");
	ytImage.onmouseover = function() {  ytImage.src = "./img/youtube_icon_hover.png"; }
	ytImage.onmouseout = function() {  ytImage.src = "./img/youtube_icon.png"; }
